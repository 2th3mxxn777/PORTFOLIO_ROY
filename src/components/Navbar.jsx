      ...
      <nav className={`mx-auto max-w-7xl flex items-center justify-between transition-all duration-500 rounded-lg overflow-hidden
        ...
        >
          <div className="relative w-10 h-10 flex items-center justify-center">
            ...
            <span className="text-black dark:text-white font-black text-xs tracking-tighter"><strong>PR</strong></span>
          </div>
          <div className="flex flex-col border-l border-black/10 dark:border-white/10 pl-4">
            ...
            <div className="flex items-center gap-2">
               ...
               <span className="text-[8px] uppercase tracking-[0.1em] text-black/40 dark:text-white/40">IT EXPERT</span>
            </div>
          </div>
        </div>
          ...
          <>
            ...
            >
               ...
               <div className="mt-auto border-t border-black/5 dark:border-white/5 pt-6">
                  <p className="text-[8px] text-black/20 dark:text-white/20 tracking-widest uppercase mb-4">Core V.2026.02</p>
               </div>
            </motion.div>
          </>
        )}
